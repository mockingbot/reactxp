...
import * as RXInterface from 'reactxp/dist/common/Interfaces';
import ViewBase from 'reactxp/dist/native-common/ViewBase';
...
interface Props extends RXInterface.Types.ScrollViewProps {
    refreshControl?: React.ReactElement<RN.RefreshControlProps>;
}
export class ScrollView extends ViewBase<Props, RXInterface.Types.Stateless, RN.ScrollView> implements RXInterface.ScrollView {
    ...
    render() {
        ...
        const internalProps: RN.ScrollViewProps & React.Props<RN.ScrollView> = {
            ...
            // ((event?: NativeSyntheticEvent<NativeScrollEvent> | undefined) => void) | undefined
